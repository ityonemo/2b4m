...
pub fn addTests(
    ...
    ctx.ok(&.{ "check", "tests/cases/import_axiom_taint/user.bpa", "--axioms" },
        \\OK: 9 declarations, 1 theorems proven
        \\  — rests on 1 axiom(s):
        \\      pZero  (tests/cases/import_axiom_taint/lib.bpa:8)
        \\
    );
